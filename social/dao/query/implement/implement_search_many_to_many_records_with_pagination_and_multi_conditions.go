...
func (d *DbToolHelper[T]) SearchManyToManyRecordsWithPaginationAndMultiConditions(ctx context.Context, pageIndex, pageSize int, preloads []_interface.PreloadFunc, queryConditions map[string]interface{}, joinsCondition, whereCondition string, orderBy ...string) ([]*T, int64, error) {
	var (
		results []*T
		count   int64
	)
